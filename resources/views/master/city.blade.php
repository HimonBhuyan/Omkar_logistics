...
<div class="master-wrapper">
    ...
    <div class="master-list-panel">
        <form id="bulkDeleteForm" method="POST" action="{{ route('master.city.bulk_destroy') }}" onsubmit="return confirm('Delete selected cities?')">
            @csrf @method('DELETE')
                ...
                <div>
                    ...
                    <div class="f-row">
                        ...
                        <select name="state" id="state_select">
                            ...
                            @foreach($states as $s)
                                <option value="{{ $s->name }}" {{ old('state', $selected->state) == $s->name ? 'selected' : '' }}>{{ $s->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
